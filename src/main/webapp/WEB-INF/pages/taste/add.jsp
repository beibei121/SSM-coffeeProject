     ...
     <div class="admin_center">
         <div class="col-md-10 right_mu">
             <div>
                 ...
                 <div class="col-sm-6">
                 <h3 class="text-center page_tit">新增口味列表</h3>
                 <form method="post" modelAttribute="coffee" class="form-horizontal" enctype="multipart/form-data"
                       action="javascript:add()">

             <div class="c_div_css">
                 <span class="c_tit_css">口味名称：</span>
                 <div class="c_right_css">
                     <input type="text" class="form-control" required id="name" name="name" value="" placeholder="请输入口味名称"/>
                 </div>
             </div>
