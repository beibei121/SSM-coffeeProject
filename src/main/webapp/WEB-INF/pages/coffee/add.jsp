     ...
     <div class="admin_center">
         <div class="col-md-10 right_mu">
             <div>
                 ...
                 <form method="post" onsubmit="return validateAdd()" id="form" class="form-horizontal" enctype="multipart/form-data"
                       action="admin/Coffee/addCoffee">
             <div class="c_div_css">
             ...
             <div class="c_div_css">
                 ...
                 <div class="c_right_css">
                     <select name="CoffeetypeId" id="CoffeetypeId" required class="form-control">
             ...
             <div class="c_div_css">
                 ...
                 <div class="c_right_css">
                     <select name="tasteId" id="tasteId" required class="form-control">
