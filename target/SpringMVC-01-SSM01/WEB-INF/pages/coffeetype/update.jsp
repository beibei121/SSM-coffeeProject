         ...
         <div class="col-md-10 right_mu">
             ...
             <div class="c_div_css">
                 ...
                 <div class="c_right_css">
                     <!-- 咖啡类型的id值 -->
                     <input type="hidden" id="coffeetypeid" value="${coffeetype.id}">
                     <input type="text" class="form-control" required id="name" name="name" value="${coffeetype.name}" placeholder="请输入咖啡名称"/>
                 </div>
             </div>
