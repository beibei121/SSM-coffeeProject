            ...
            <div class="col-sm-3"></div>
             ...
             <div class="c_div_css">
                 ...
                 <div class="c_right_css">
                     <img style="width: 100px;height: 100px;margin-bottom: 10px;" src="${coffee.pic}" />
                 </div>
             </div>
             <div class="c_div_css">
             ...
             <div class="c_div_css">
                 ...
                 <div class="c_right_css">
               <p>${coffee.coffeetypeobj.coffeetypename}</p>
                 </div>
             </div>
             <div class="c_div_css">
             ...
             <div class="text-center">
                     <button  onclick="history.go(-1)"  class="button1" type="button"><span class="span_1">返&nbsp;&nbsp;回</span></button>
             </div>
            </div>
            <div class="col-sm-3"></div>
        </div>
